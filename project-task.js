...
let new_saleprice = products.forEach(product => {
  product.salePrice = discount10(product);
});

console.log(new_saleprice);
...
let total_value = products.reduce((acc, curr) => {return acc + curr.price}, 0)
...
console.log("Discounted products:", new_saleprice);
